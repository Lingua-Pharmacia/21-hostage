...
// PERSISTENCE (Specific to Hostages)
let lifetimeScore = parseInt(localStorage.getItem('hostagesScore')) || 0;
let completedLessons = JSON.parse(localStorage.getItem('completedHostagesLessons')) || [];
...
// STATIONS 
const stations = [
    {file:"01_AchilleLauroHijacking.mp3", title:"Achille Lauro Hijacking"},
    {file:"02_AldoMoroKidnapping.mp3", title:"Aldo Moro Kidnapping"},
    {file:"03_BalcombeStreetSiege.mp3", title:"Balcombe Street Siege"},
    {file:"04_BudyonnovskHospitalCrisis.mp3", title:"Budyonnovsk Hospital Crisis"},
    {file:"05_DominicanEmbassySiege.mp3", title:"Dominican Embassy Siege"},
    {file:"06_DutchTrainHostageCrisis.mp3", title:"Dutch Train Hostage Crisis"},
    {file:"07_ElAlFlight426.mp3", title:"El Al Flight 426 Hijacking"},
    {file:"08_GarudaIndonesiaFlight206.mp3", title:"Garuda Indonesia Flight 206"},
    {file:"09_GettyKidnapping.mp3", title:"Getty Kidnapping"},
    {file:"10_GrandMosqueSeizure.mp3", title:"Grand Mosque Seizure"},
    {file:"11_HanafiSiege.mp3", title:"Hanafi Siege"},
    {file:"12_HeinekenKidnapping.mp3", title:"Heineken Kidnapping"},
    {file:"13_HijackingsOfLeilaKhaled.mp3", title:"Hijackings of Leila Khaled"},
    {file:"14_IndianAirlinesFlight814.mp3", title:"Indian Airlines Flight 814"},
    {file:"15_IngridBetancourtKidnapping.mp3", title:"Ingrid Betancourt Kidnapping"},
    {file:"16_IranHostageCrisis.mp3", title:"Iran Hostage Crisis"},
    {file:"17_LibyanEmbassySiege.mp3", title:"Libyan Embassy Siege"},
    {file:"18_PalaceOfJusticeSiege.mp3", title:"Palace of Justice Siege"},
    {file:"19_PanAmFlight73.mp3", title:"Pan Am Flight 73 Hijacking"},
    {file:"20_PattyHearstKidnapping.mp3", title:"Patty Hearst Kidnapping"},
    {file:"21_SingaporeAirlinesFlight117.mp3", title:"Singapore Airlines Flight 117"}
];
...
function finishQuiz() {
    lifetimeScore += totalScore; localStorage.setItem('hostagesScore', lifetimeScore);
    const fn = audio.src.split('/').pop();
    if(!completedLessons.includes(fn)) {
        completedLessons.push(fn); localStorage.setItem('completedHostagesLessons', JSON.stringify(completedLessons));
    }
